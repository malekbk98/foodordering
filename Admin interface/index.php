                ...
                <div class="app-sidebar colored">
                    ...
                    <div class="sidebar-content">
                        ...
                        <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="pages/employee_list.php" class="menu-item"><i class="ik ik-users"></i><span>Employees List</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/add_profile.php" class="menu-item"><i class="ik ik-user-plus"></i><span>Add New Employee</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="pages/widget-statistic.html" class="menu-item"><i class="ik ik-file-text"></i><span>Statistic</span></a>
                                </div>
