                    ...
                    <div class="sidebar-content">
                        ...
                        <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item active">
                                    <a href="availbel_product.php" class="menu-item"><i class="ik ik-box"></i><span>Availbel Products</span></a>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="availbel_product.php">Availbel Products</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
