                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    while($data = $req->fetch()){
                                                        ...
                                                        if($data['status']==0){
                                                            echo '<td><a href="accept_order1.php?id='.$data['oid'].'"><button class="btn btn-success glyphicon glyphicon-edit">Accept</button></a></td>';
                                                            ...
                                                            if($data['status']==2){
                                                                echo '<td><a href=""><button class="btn btn-success glyphicon glyphicon-edit">DONE</button></a></td>';
                                                            }
                                                        }
